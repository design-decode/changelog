...
export default function DateTemplate() {
	return (
		<div className="flex gap-space-7 w-full">
			<div className="text-2 font-regular w-[88px] sticky top-0 flex flex-col gap-space-4 [mask-image:_linear-gradient(#00000003_4%,rgb(0,0,0)_197px,transparent_30%)]">
				<div className=" text-slate-11 -translate-y-7">May 17, 2023</div>
				<div className=" text-slate-11 -translate-y-7">May 17, 2023</div>
				<div className=" text-slate-11 -translate-y-7">May 17, 2023</div>
				<div className=" text-slate-11 -translate-y-7">May 17, 2023</div>
				<div className=" text-slate-11 -translate-y-7">May 17, 2023</div>
				<div className=" text-slate-11  translate-y-0">May 17, 2023</div>
				<div className=" text-slate-11 translate-y-7">May 17, 2023</div>
				<div className=" text-slate-11 translate-y-7">May 17, 2023</div>
				<div className=" text-slate-11 translate-y-7">May 17, 2023</div>
				<div className=" text-slate-11 translate-y-7">May 17, 2023</div>
			...
			<div className="flex flex-col gap-space-9">
				<div className="max-w-[600px] border-b border-b-indigoA-4 pb-space-4">
					...
					<p className="font-regular text-1.1 text-slate-11 mb-space-4">
						This is where our enhanced insider reports pages come in handy. The improved filtering and color-coded symbols allow you to track and interpret this insider trading activity more easily, leading to more informed investment decisions. As always, we strive
						to equip you with the most accurate and accessible financial information, so you can invest confidently.
					</p>
